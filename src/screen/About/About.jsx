      ...
      <div className="w-3/4 h-full px-6">
        ...
        <div className="w-3/4 flex justify-start flex-col mt-2">
          ...
          <p className="mt-2">
            ...
            integrates health data, medical records, and real-time assistance to
            provide comprehensive healthcare solutions tailored to each family
            member's unique needs.
          </p>
          <p className="mt-4">
            With our user-friendly interface and intuitive design, families can
            effortlessly track their health metrics, communicate with healthcare
            providers, and access resources to make informed decisions about
            their care.
          </p>
        </div>
        <div className="mt-6">
