    ...
    <div className='backgroundScreens min-w-full min-h-[90lvh] text-primary-blue absolute'>
        <form onSubmit={handleSubmit} className="w-full h-full mt-24 pt-10 bg-transparent flex justify-center items-center pb-80" noValidate>
            ...
            <div className="mb-5">
                ...
                <input autoFocus onChange={handleEmail} type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="little@demon.com" required />
